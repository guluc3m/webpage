...
<?php
		    ...
		    $output = '<span class="sbox_l"></span><span class="sbox"><input name="searchword" id="mod_search_searchword" maxlength="100" alt="'.$button_text.'" class="inputbox'.$moduleclass_sfx.'" type="text" size="'.$width.'" value="'.$text.'"  onblur="if(this.value==\'\') this.value=\''.$text.'\';" onfocus="if(this.value==\''.$text.'\') this.value=\'\';"    /></span><span class="sbox_r" id="srch_clear"></span>';
