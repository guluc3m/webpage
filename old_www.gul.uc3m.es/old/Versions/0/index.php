...
<body>
    <div id="page">
	    ...
	    <table>
		<tr>
		<td align="center"><img src="<? echo "$home/img/portada/$photo1" ?>" alt="<? echo $photo1 ?>" width="185px" /></td>
		<td align="center"><img src="<? echo "$home/img/portada/$photo2" ?>" alt="<? echo $photo2 ?>" width="185px" /></td>
		<td align="center"><img src="<? echo "$home/img/portada/$photo3" ?>" alt="<? echo $photo3 ?>" width="185px" /></td>
		</tr>
	    </table>
...
//		                setlocale(LC_ALL,'es_ES.ISO-8859-15@euro');
		        ...
		        #	echo '<h5>'.date('j F Y H:i', filemtime("$home/noticias/$noticia[$i]")).'</h5>';
		                ...
		                echo '<p>'.$parrafo.'</p>';
		        	echo "<h5><a href=\"$home/noticia.php?noticia=$noticia[$i]\">Pulsa aquí para leer más</a></h5>";
		                fclose($new);
		    }
		    #        }
		    #}
