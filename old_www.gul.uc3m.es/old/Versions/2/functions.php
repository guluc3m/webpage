...
function menu($home){?>
    <ul id="menu">
	<li class="toplink"><a href="<? echo "$home/actividades.php"; ?>">Actividades</a></li>
	<li class="normallink"><a href="http://wiki.gul.es/doku.php?id=wiki:documentacion">Documentacion</a></li>
