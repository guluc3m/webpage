...
<body>
    <div id="page">
        ...
        <h3> Alojamiento de proyectos </h3>
		<p>Tenemos una máquina para alojar todo tipo de proyectos. Cada uno de ellos tiene un trac y un repositorio SVN.</p>
		<p> <a href='http://tracs.gul.es'>Pulsa aquí para acceder</a></p>

		<h3>gentoo-es.org</h3>
		<p>Una de nuestras m&aacute;quinas aloja a los chicos de gentoo-es</p>
		<p><a href="http://gentoo-es.org"><img src="http://www.gentoo-es.org/themes/gentoo-es/logo.png" alt="gentoo-es" /></a></p>
