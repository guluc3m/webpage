...
$conf['baseurl']     = '';                //URL to server including protoseurl']     = '';
...
$conf['fullpath']    = 1;                 //show full path of the document or relative to datadir only? 0|1
...
$conf['resendpasswd']= 1;                //allow resend password function?
